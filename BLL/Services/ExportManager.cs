    ...
    public partial class ExportManager : IExportManager
    {
            ...
            var properties = new[]
          {
               ...
               new PropertyByName<Order>("产品名称", p => p.ShopName),
                ...
                new PropertyByName<Order>("佣金", p => p.Commission),
                 new PropertyByName<Order>("支付价格", p => p.PayPrice),
                new PropertyByName<Order>("支付佣金", p => p.PayCommission),
                 new PropertyByName<Order>("支付时间", p => p.PayTime),
                  new PropertyByName<Order>("支付类型", p => p.PayType),
        ...
        public byte[] ExportChannelDataToXlsx(IList<ChannelData> channelDatas)
        {
            var properties = new[]
           {
            ...
            return ExportToXlsx(properties, channelDatas);
        }
    }
}
